...
#include "test_interfaces/action/detail/fibonacci__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const test_interfaces::action::Fibonacci_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  test_interfaces::action::Fibonacci_Goal & ros_message)
{
  // Member: number
  cdr >> ros_message.number;
...
{
  auto typed_message =
    static_cast<const test_interfaces::action::Fibonacci_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<test_interfaces::action::Fibonacci_Goal *>(
    untyped_ros_message);
...
{
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces, action, Fibonacci_Goal)() {
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_test_interfaces
cdr_serialize(
  const test_interfaces::action::Fibonacci_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: array
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  test_interfaces::action::Fibonacci_Result & ros_message)
{
  // Member: array
  {
    cdr >> ros_message.array;
...
{
  auto typed_message =
    static_cast<const test_interfaces::action::Fibonacci_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<test_interfaces::action::Fibonacci_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces, action, Fibonacci_Result)() {
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_test_interfaces
cdr_serialize(
  const test_interfaces::action::Fibonacci_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: part_array
  {
    cdr << ros_message.part_array;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  test_interfaces::action::Fibonacci_Feedback & ros_message)
{
  // Member: part_array
  {
    cdr >> ros_message.part_array;
  ...
  size_t current_alignment)
{
  ...
  // Member: part_array
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.part_array[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
  auto typed_message =
    static_cast<const test_interfaces::action::Fibonacci_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<test_interfaces::action::Fibonacci_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces, action, Fibonacci_Feedback)() {
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_Feedback__handle;
}
...
{
bool cdr_serialize(
  const test_interfaces::action::Fibonacci_Goal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  test_interfaces::action::Fibonacci_Goal &);
size_t get_serialized_size(
  const test_interfaces::action::Fibonacci_Goal &,
  size_t current_alignment);
size_t
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_test_interfaces
cdr_serialize(
  const test_interfaces::action::Fibonacci_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  test_interfaces::action::Fibonacci_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        test_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Goal(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const test_interfaces::action::Fibonacci_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<test_interfaces::action::Fibonacci_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces, action, Fibonacci_SendGoal_Request)() {
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_test_interfaces
cdr_serialize(
  const test_interfaces::action::Fibonacci_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  test_interfaces::action::Fibonacci_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const test_interfaces::action::Fibonacci_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<test_interfaces::action::Fibonacci_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces, action, Fibonacci_SendGoal_Response)() {
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Response__handle;
}
...
{
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces, action, Fibonacci_SendGoal)() {
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_test_interfaces
cdr_serialize(
  const test_interfaces::action::Fibonacci_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  test_interfaces::action::Fibonacci_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
...
{
  auto typed_message =
    static_cast<const test_interfaces::action::Fibonacci_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<test_interfaces::action::Fibonacci_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces, action, Fibonacci_GetResult_Request)() {
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Request__handle;
}
...
{
bool cdr_serialize(
  const test_interfaces::action::Fibonacci_Result &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  test_interfaces::action::Fibonacci_Result &);
size_t get_serialized_size(
  const test_interfaces::action::Fibonacci_Result &,
  size_t current_alignment);
size_t
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_test_interfaces
cdr_serialize(
  const test_interfaces::action::Fibonacci_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  test_interfaces::action::Fibonacci_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        test_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Result(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const test_interfaces::action::Fibonacci_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<test_interfaces::action::Fibonacci_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces, action, Fibonacci_GetResult_Response)() {
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Response__handle;
}
...
{
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces, action, Fibonacci_GetResult)() {
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult__handle;
}
...
{
bool cdr_serialize(
  const test_interfaces::action::Fibonacci_Feedback &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  test_interfaces::action::Fibonacci_Feedback &);
size_t get_serialized_size(
  const test_interfaces::action::Fibonacci_Feedback &,
  size_t current_alignment);
size_t
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_test_interfaces
cdr_serialize(
  const test_interfaces::action::Fibonacci_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  test_interfaces::action::Fibonacci_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        test_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Feedback(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const test_interfaces::action::Fibonacci_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<test_interfaces::action::Fibonacci_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces, action, Fibonacci_FeedbackMessage)() {
  return &test_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_FeedbackMessage__handle;
}
